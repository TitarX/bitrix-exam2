...
if (is_numeric($arParams['CLASS_NAV_PAGE_SIZE'])) {
	$arNavParams = array(
		"nPageSize" => $arParams['CLASS_NAV_PAGE_SIZE'],
		"bDescPageNumbering" => $arParams["CLASS_NAV_TITLE"]
	);
	$arNavigation = CDBResult::GetNavParams($arNavParams);
	
	$arNavStartParams = array('nPageSize' => $arParams['CLASS_NAV_PAGE_SIZE']);
}
...
if ($this->startResultCache(false, array($USER->GetGroups(), $arNavigation))) {
	...
	$arClass = array();
	if (is_numeric($arParams['CLASS_NAV_PAGE_SIZE'])) {
		$arResult['NAV_STRING'] = $rsElement->GetPageNavString($arParams['CLASS_NAV_TITLE']);
	}
